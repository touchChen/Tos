...
#define	MAX_DRIVES		2    // 两块硬盘
#define	NR_PART_PER_DRIVE	4    // 一块硬盘有四个分区
#define	NR_SUB_PER_PART		16   // 每个扩展分区最多可以划分为16个逻辑分区
#define	NR_SUB_PER_DRIVE	(NR_SUB_PER_PART * NR_PART_PER_DRIVE)
#define	NR_PRIM_PER_DRIVE	(NR_PART_PER_DRIVE + 1)  // 一块硬盘的主设备号数  例如：hd0 (hd1,hd2,hd3,hd4)
...
#define TOS_PART	0x98	/* TOS's partition */
